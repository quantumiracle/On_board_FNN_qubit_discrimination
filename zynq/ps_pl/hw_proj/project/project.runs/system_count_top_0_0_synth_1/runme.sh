...
HD_PWD='D:/Users/jmcui/workspace/ps_pl6/ps_pl6/ps_pl/hw_proj/project/project.runs/system_count_top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_count_top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_count_top_0_0.tcl
