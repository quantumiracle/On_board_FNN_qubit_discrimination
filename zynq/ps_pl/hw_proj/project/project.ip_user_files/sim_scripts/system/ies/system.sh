...
bfm_lib_dir="D:/xilink_sdx/SDx/2016.4/Vivado/lib/win64.o"
...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../project.srcs/sources_1/bd/system/ipshared/7dd0/hdl" \
       +incdir+"$ref_dir/../../../../project.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
       +incdir+"../../../../project.srcs/sources_1/bd/system/ipshared/7dd0/hdl" \
       +incdir+"../../../../project.srcs/sources_1/bd/system/ipshared/7e3a/hdl" \
