...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set BRIGHT [ create_bd_port -dir O BRIGHT ]
  set GATE [ create_bd_port -dir I GATE ]
  set PMT [ create_bd_port -dir I PMT ]
  set RST_N [ create_bd_port -dir I -type rst RST_N ]
  set out1 [ create_bd_port -dir O out1 ]

  # Create instance: count_top_0, and set properties
  set block_name count_top
  set block_cell_name count_top_0
  if { [catch {set count_top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $count_top_0 eq "" } {
...
CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /myip_v1_0_0/s_axi]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins myip_v1_0_0/s_axi] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net GATE_1 [get_bd_ports GATE] [get_bd_pins count_top_0/GATE]
  connect_bd_net -net PMT_1 [get_bd_ports PMT] [get_bd_pins count_top_0/PMT]
  connect_bd_net -net RST_N_1 [get_bd_ports RST_N] [get_bd_pins count_top_0/RST_N]
  connect_bd_net -net count_top_0_CLEAR [get_bd_pins count_top_0/CLEAR] [get_bd_pins myip_v1_0_0/clear]
  connect_bd_net -net count_top_0_COUNTER [get_bd_pins count_top_0/COUNTER] [get_bd_pins myip_v1_0_0/data]
  connect_bd_net -net count_top_0_INT [get_bd_ports out1] [get_bd_pins count_top_0/INTR] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net myip_v1_0_0_bright [get_bd_ports BRIGHT] [get_bd_pins myip_v1_0_0/bright]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins count_top_0/CLK] [get_bd_pins myip_v1_0_0/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins myip_v1_0_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myip_v1_0_0/s_axi/reg0] SEG_myip_v1_0_0_reg0

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   guistr: "# # String gsaved with Nlview 6.6.5b  2016-09-06 bk=1.3687 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
preplace port GATE -pg 1 -y 490 -defaultsOSRD
preplace port DDR -pg 1 -y 240 -defaultsOSRD
preplace port PMT -pg 1 -y 510 -defaultsOSRD
preplace port RST_N -pg 1 -y 470 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 260 -defaultsOSRD
preplace port BRIGHT -pg 1 -y 120 -defaultsOSRD
preplace port out1 -pg 1 -y 400 -defaultsOSRD
preplace inst myip_v1_0_0 -pg 1 -lvl 3 -y 120 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 90 -defaultsOSRD
preplace inst count_top_0 -pg 1 -lvl 2 -y 500 -defaultsOSRD
...
preplace netloc RST_N_1 1 0 2 NJ 470 640
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 630J
preplace netloc count_top_0_INT 1 0 4 30 430 670J 420 940J 420 1220J
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 650 -50 950J
preplace netloc count_top_0_CLEAR 1 2 1 980
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 0 620
preplace netloc PMT_1 1 0 2 20J 530 N
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 260 NJ 260 NJ
preplace netloc myip_v1_0_0_bright 1 3 1 N
preplace netloc count_top_0_COUNTER 1 2 1 960
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 -10 660 360 970J
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 940
preplace netloc GATE_1 1 0 2 NJ 490 620
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 640
levelinfo -pg 1 0 450 820 1110 1470 -top -230 -bot 570
",
}
