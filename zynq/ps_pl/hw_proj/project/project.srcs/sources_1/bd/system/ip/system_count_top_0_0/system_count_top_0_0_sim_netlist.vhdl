...
entity system_count_top_0_0_clk_div_33k is
  port (
  ...
  attribute ORIG_REF_NAME of system_count_top_0_0_clk_div_33k : entity is "clk_div_33k";
end system_count_top_0_0_clk_div_33k;

architecture STRUCTURE of system_count_top_0_0_clk_div_33k is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_count_top_0_0_counter is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_count_top_0_0_counter : entity is "counter";
end system_count_top_0_0_counter;

architecture STRUCTURE of system_count_top_0_0_counter is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity system_count_top_0_0_count_top is
  port (
    COUNTER : out STD_LOGIC_VECTOR ( 7 downto 0 );
    INTR : out STD_LOGIC;
    CLEAR : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of system_count_top_0_0_count_top : entity is "count_top";
end system_count_top_0_0_count_top;

architecture STRUCTURE of system_count_top_0_0_count_top is
  signal CLK_33K : STD_LOGIC;
  signal clk33_signal_1 : STD_LOGIC;
  signal clk_div_33k_n_1 : STD_LOGIC;
  signal counter_n_1 : STD_LOGIC;
begin
clk_div_33k: entity work.system_count_top_0_0_clk_div_33k
     port map (
      AR(0) => counter_n_1,
      CLK => CLK,
      CLK_33K => CLK_33K,
...
counter_RnM: entity work.system_count_top_0_0_counter
     port map (
      AR(0) => counter_n_1,
      CLEAR => CLEAR,
      CLK => CLK,
...
entity system_count_top_0_0 is
  ...
  attribute NotValidForBitStream of system_count_top_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of system_count_top_0_0 : entity is "system_count_top_0_0,count_top,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of system_count_top_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of system_count_top_0_0 : entity is "count_top,Vivado 2016.4_sdx";
end system_count_top_0_0;

architecture STRUCTURE of system_count_top_0_0 is
begin
inst: entity work.system_count_top_0_0_count_top
     port map (
      CLEAR => CLEAR,
      CLK => CLK,
      COUNTER(7 downto 0) => COUNTER(7 downto 0),
